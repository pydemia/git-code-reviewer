...
작성일: 2026-09-15
상태: G01–G04 완료. CD 2.11.3 로컬 설치와 실제 Extension Host의 원문 pulling·출처 표시·Luna/high 세 사례 검증을 완료했다. 기존 사용자 Host는 강제 재로드하지 않았으며 적용 버전은 미확정이다. Marketplace 게시는 별도 작업으로 보류한다. [G04 실행 기록](execution/review-memory-pull/G04.md)에 수용 기준별 근거와 제한을 기록했다.
...
| G04 | 실제 과거 사례로 전체 흐름 검증·최종 전달 | G01–G03 | 완료 |
